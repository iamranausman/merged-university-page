  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        let countriesRes = await fetch(`/api/frontend/singlevisacountry?slug=${slug}`, {
          method: "POST"
        });
        ...
        setCountry(countriesData.country_details);

        setAdminVisaTypes(countriesData.visa_types)

        setVisaRequirements(countriesData.visa_requirements)

...
export async function POST(req) {
  ...
  try {
    ...
    const record = await prisma.complaints.create({ data: body });
...
export async function PATCH(req) {
  ...
  try {
    ...
    const record = await prisma.complaints.findUnique({ where: { id: parseInt(id) } });
    if (!record) {

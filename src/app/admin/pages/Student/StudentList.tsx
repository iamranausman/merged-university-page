...
const StudentList = () => {
  ...
  const fetchStudents = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/internal/students?${params.toString()}`);
  ...
  const toggleStudentStatus = async (id) => {
    try {
      ...
      const result = await Swal.fire({
        title: `Are you sure?`,
        text: `Do you want to ${newStatus ? 'activate' : 'deactivate'} this student?`,
        icon: 'warning',
      ...
      if (result.isConfirmed) {
        const response = await fetch(`/api/internal/students`, {
          method: "PUT",
        ...
        {students.length === 0 && (
          <div className="text-center py-12">
            <div className="text-gray-500 text-lg">
              {hasActiveFilters ? 'No students found matching your filters.' : 'No students available.'}
            </div>
            <p className="text-gray-400 mt-2">
              {hasActiveFilters ? 'Try adjusting your search criteria or clear filters' : 'No student records have been created yet'}
            </p>
            {hasActiveFilters && (
              <button
                onClick={clearFilters}
          ...
          <div className="bg-white rounded-lg p-6 max-w-md mx-4">
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <div className="flex justify-between">
                ...
                <span>{selectedStudent.userType || 'N/A'}</span>
              </div>
              <div className="flex justify-between">
